...
function seedInitialMemories(db: DatabaseSync) {
  ...
  const initialMemories = [
    ...
    },
    {
      ...
      user_id: "default_user",
      type: "preference",
      content: "Natural language is Gujarati, especially Kathiyawadi Gujarati and Gujlish. Mery is their personal female companion (smart, playful, caring, witty). Always reply naturally in Gujarati/Kathiyawadi; never suddenly switch to English.",
      normalized_category: "communication",
      normalized_key: "primary_language_dialect",
      normalized_value: "kathiyawadi_gujarati",
      status: "active",
      importance: 0.99,
      ...
      last_confirmed_at: now,
      version: 1,
      tags: JSON.stringify(["language", "gujarati", "kathiyawadi", "companion", "mery"]),
